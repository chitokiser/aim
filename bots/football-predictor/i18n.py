...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "choose_currency": (
            "Choose how to bet:\n\n"
            "💰 *AP* — Exchangeable (10,000 AP = $1)\n"
            "🎟️ *P* — Free daily points (non-exchangeable)\n\n"
        ...
        "ranking_row": "{rank}. *{name}* — {correct} wins | {rate}% | {earned:,} AP",
    ...
    "ko": {
        ...
        "ranking_row": "{rank}. *{name}* — {correct}회 적중 | {rate}% | {earned:,} AP",
    ...
    "vi": {
        ...
        "choose_currency": (
            ...
            "💰 *AP* — Có thể đổi (10,000 AP = $1)\n"
            "🎟️ *P* — Điểm miễn phí hàng ngày (không đổi được)\n\n"
            "Số dư — AP: *{ap:,}* | P: *{p:,}*"
        ),
        ...
        "ranking_row": "{rank}. *{name}* — {correct} thắng | {rate}% | {earned:,} AP",
        ...
        "settle_ok": "✅ Đã giải quyết: {home} {hs} - {as_} {away}\n🏆 Người thắng: {winners} | Tổng thưởng: {payout:,} AP",
